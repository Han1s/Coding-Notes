...
## 345. Getting a single Meetup Details and preparing pages
...
## 37. Deploying Next.js Projects

- using Vercel for NextJS applications (its the same team that developed NextJS)

# 24. Animating React Ap ps
